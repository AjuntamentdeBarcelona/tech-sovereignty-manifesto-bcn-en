...
:_title: Manifesto for technological sovereignty and citizens' digital rights for cities
//
...
:_summary: Manifesto in favor technological sovereignty and citizens' digital rights for cities.
//
